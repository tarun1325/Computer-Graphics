...
void View ::drawBox()
{
	...
	glBegin( GL_LINES);
		...
		// Front Box
		float trans_z1 = nearZ;
		glVertex3f(leftX, bottomY, trans_z1);			//A	// Bottom Line
		glVertex3f(rightX, bottomY, trans_z1);			//B	
		glVertex3f(leftX, topY, trans_z1);			//C	// Top Line
		glVertex3f(rightX, topY, trans_z1);			//D
		glVertex3f(leftX, bottomY, trans_z1);			//A	// Left Line
		glVertex3f(leftX, topY, trans_z1);			//C
		glVertex3f(rightX,bottomY, trans_z1);			//B	// Right Line
		glVertex3f(rightX, topY, trans_z1);			//D
		
		// Back box
		//glTranslatef(0.0, 0.0,-0.5);
		float trans_z2 = farZ;
		glVertex3f(leftX, bottomY, trans_z2);			//A1	// Bottom Line
		glVertex3f(rightX, bottomY, trans_z2);			//B1	
		glVertex3f(leftX, topY, trans_z2);			//C1	// Top Line
		glVertex3f(rightX, topY, trans_z2);			//D1
		glVertex3f(leftX, bottomY, trans_z2);			//A1	// Left Line
		glVertex3f(leftX, topY, trans_z2);			//C1
		glVertex3f(rightX,bottomY, trans_z2);			//B1	// Right Line
		glVertex3f(rightX, topY, trans_z2);			//D1
